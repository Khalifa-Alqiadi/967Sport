                    ...
                    <li class="nav-item inline dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-scale pull-right">
                            ...
                            <a class="dropdown-item"
                                href="{{ @$Topic->webmasterSection->type == 4 || @$Topic->webmasterSection->type == 6 ? route('topicView', ['webmasterId' => @$Topic->webmasterSection->id, 'id' => $Topic->id]) : Helper::topicURL($Topic->id, '', $Topic) }}"
                                {!! @$Topic->webmasterSection->type == 4 || @$Topic->webmasterSection->type == 6 ? '' : "target='_blank'" !!}><i class="material-icons">&#xe8f4;</i>
                                {{ __('backend.preview') }}</a>
            ...
            <ul class="nav nav-md light dk">
                @if ($WebmasterSection->type == 10)
                    <li class="nav-item inline">
                        <a class="nav-link {{ $tab_0 }}" data-toggle="tab" data-target="#tab_landing"
                            href="#">
                ...
                <li class="nav-item inline">
                    <a class="nav-link {{ $tab_1 }}" data-toggle="tab" data-target="#tab_details" href="#">
                        <span class="text-md"><i class="material-icons">
                                &#xe31e;</i>
                            {{ $WebmasterSection->type == 10 ? __('backend.pageInfo') : __('backend.topicTabDetails') }}</span>
                    </a>
                </li>

                @if ($WebmasterSection->multi_images_status)
                    <li class="nav-item inline">
                        <a class="nav-link  {{ $tab_3 }}" data-toggle="tab" data-target="#tab_photos"
                            href="#">
                            <span class="text-md"><i class="material-icons">
                                    &#xe251;</i>
                ...
                @if ($WebmasterSection->comments_status)
                    <li class="nav-item inline">
                        <a class="nav-link  {{ $tab_4 }}" data-toggle="tab" data-target="#tab_comments"
                            href="#">
                            <span class="text-md"><i class="material-icons">
                ...
                @if ($WebmasterSection->maps_status)
                    <li class="nav-item inline">
                        <a class="nav-link  {{ $tab_5 }}" id="mapTabLink" data-toggle="tab" data-target="#tab_maps"
                            href="#">
                            <span class="text-md"><i class="material-icons">
                ...
                @if ($WebmasterSection->related_status)
                    <li class="nav-item inline">
                        <a class="nav-link  {{ $tab_7 }}" data-toggle="tab" data-target="#tab_related"
                            href="#">
                            <span class="text-md"><i class="material-icons">
                ...
                @if ($WebmasterSection->code_status)
                    <li class="nav-item inline">
                        <a class="nav-link  {{ $tab_8 }}" data-toggle="tab" data-target="#tab_code"
                            href="#">
                            <span class="text-md"><i class="material-icons">
            ...
            <div class="tab-content b-t clear b-t">
                <div class="tab-pane  {{ $tab_1 }}" id="tab_details">
                    <div class="box-body p-a-2">
                        <form method="POST"
                            action="{{ route('topicsUpdate', ['webmasterId' => $WebmasterSection->id, 'id' => $Topic->id]) }}"
                                        ...
                                        <div class="form-group">
                                            <div class='input-group date' ui-jp="datetimepicker"
                                                ...
                                                <input type="text" name="date" id="date" class="form-control"
                                                    value="{{ Helper::formatDate($Topic->date) }}" placeholder=""
                                                    maxlength="191" autocomplete="off" required>
                                        ...
                                        <div class="form-group">
                                            <div class='input-group date' ui-jp="datetimepicker"
                                                ...
                                                <input type="text" name="expire_date" id="expire_date"
                                                    class="form-control"
                                                    value="{{ Helper::formatDate($Topic->expire_date) }}" placeholder=""
                            ...
                            @if ($WebmasterSection->sections_status != 0)
                                <div class="form-group row">
                                    <label for="section_id" class="col-sm-2 form-control-label">{!! __('backend.categories') !!}
                                    </label>
                                    <div class="col-sm-10">
                                        <select name="section_id[]" id="cat_ids" class="form-control select2-multiple"
                                            multiple ui-jp="select2" ui-options="{theme: 'bootstrap'}" required
                                            onchange="load_custom_fields()">
                                            <?php
                                            $title_var = 'title_' . @Helper::currentLanguage()->code;
                                            $title_var2 = 'title_' . config('smartend.default_language');
                                            ...
                                            @foreach ($fatherSections as $fatherSection)
                                                ...
                                                ?>
                                                <option value="{{ $fatherSection->id }}"
                                                    {{ in_array($fatherSection->id, $categories) ? "selected='selected'" : '' }}>
                                                    {{ $ftitle }}</option>
                                                @foreach ($fatherSection->fatherSections as $subFatherSection)
                                                    ...
                                                    <option value="{{ $subFatherSection->id }}"
                                                        {{ in_array($subFatherSection->id, $categories) ? "selected='selected'" : '' }}>
                                                        {!! $ftitle !!} {!! $t_arrow !!}
                                                        {!! $title !!}</option>
                                                    ...
                                                    @foreach ($subFatherSection->fatherSections as $sub2FatherSection)
                                                        ...
                                                        ?>
                                                        <option value="{{ $sub2FatherSection->id }}"
                                                            {{ in_array($sub2FatherSection->id, $categories) ? "selected='selected'" : '' }}>
                                                            {!! $ftitle !!} {!! $t_arrow !!}
                                                            {!! $title !!} {!! $t_arrow !!}
                                                            {!! $title2 !!}</option>
                                                    @endforeach
                            ...
                            @else
                                <input type="hidden" name="section_id" id="cat_ids" value="{{ $Topic->section_id }}"
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" autocomplete="off"
                                                    name="title_{{ @$ActiveLanguage->code }}"
                                                    id="title_{{ @$ActiveLanguage->code }}"
                                                    value="{{ $Topic->{'title_' . @$ActiveLanguage->code} }}" required
                                                    maxlength="191" dir="{{ @$ActiveLanguage->direction }}"
                                                    class="form-control">
                                            </div>
                                        </div>
                                    @endif
                            ...
                            @if($WebmasterSection->id == 7)
                                <div class="form-group row">
                                    <label for="source" class="col-sm-2 form-control-label">{!!  __('backend.source') !!}
                                    </label>
                                    <div class="col-sm-10">
                                        <input type="text" autocomplete="off" name="source" id="source" value="{{$Topic->source ?? __('backend.source_default') }}" required maxlength="191" class="form-control">
                                    </div>
                                </div>
                            @else
                                <input type="hidden" name="source" id="source" value="{{$Topic->source}}">
                            @endif
                                ...
                                @if ($WebmasterSection->editor_status)
                                    ...
                                    @foreach (Helper::languagesList() as $ActiveLanguage)
                                        @if ($ActiveLanguage->box_status)
                                            <div class="form-group row">
                                                <div class="col-sm-2">
                                                    <label class="form-control-label">{!! __('backend.bannerDetails') !!}</label>
                                                    {!! @Helper::languageName($ActiveLanguage) !!}
                                                ...
                                                <div class="col-sm-10">
                                                    @if (Helper::GeneralWebmasterSettings('text_editor') == 2)
                                                        <div>
                                                            <textarea name="details_{{ @$ActiveLanguage->code }}" id="details_{{ @$ActiveLanguage->code }}"
                                                                class="form-control ckeditor" dir="{{ @$ActiveLanguage->direction }}">{{ $Topic->{'details_' . @$ActiveLanguage->code} }}</textarea>
                                                        </div>
                                                    @elseif (Helper::GeneralWebmasterSettings('text_editor') == 1)
                                                        <div>
                                                            <textarea name="details_{{ @$ActiveLanguage->code }}" id="details_{{ @$ActiveLanguage->code }}"
                                                                class="form-control tinymce" dir="{{ @$ActiveLanguage->direction }}">{{ $Topic->{'details_' . @$ActiveLanguage->code} }}</textarea>
                                                        </div>
                                                    @else
                                                        <div class="box p-a-xs">
                                                            <textarea name="details_{{ @$ActiveLanguage->code }}" id="details_{{ @$ActiveLanguage->code }}"
                                                                class="form-control summernote summernote_{{ @$ActiveLanguage->code }}" dir="{{ @$ActiveLanguage->direction }}">{{ $Topic->{'details_' . @$ActiveLanguage->code} }}</textarea>
                                                        </div>
                                                    @endif
                                    ...
                                    @foreach (Helper::languagesList() as $ActiveLanguage)
                                        @if ($ActiveLanguage->box_status)
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea name="details_{{ @$ActiveLanguage->code }}" id="details_{{ @$ActiveLanguage->code }}"
                                                        class="form-control" dir="{{ @$ActiveLanguage->direction }}" rows="5">{{ $Topic->{'details_' . @$ActiveLanguage->code} }}</textarea>
                                                </div>
                                            </div>
                                        @endif
                                    @endforeach
                            ...
                            @if ($WebmasterSection->type == 2)
                                    ...
                                    <div class="col-sm-10">
                                        <div class="radio m-t-sm">
                                            <label class="md-check">
                                                <input type="radio" name="video_type" value="0" class="has-value"
                                                    {{ $Topic->video_type == 0 ? 'checked' : '' }} id="video_type1"
                                                    onclick="document.getElementById('youtube_link_div').style.display='none';document.getElementById('embed_link_div').style.display='none';document.getElementById('vimeo_link_div').style.display='none';document.getElementById('files_div').style.display='block';document.getElementById('youtube_link').value=''">
                                                <i class="primary"></i>
                                                {{ __('backend.bannerVideoType1') }}
                                            </label>
                                            &nbsp; &nbsp;
                                            <label class="md-check">
                                                <input type="radio" name="video_type" value="1" class="has-value"
                                                    {{ $Topic->video_type == 1 ? 'checked' : '' }} id="video_type2"
                                                    onclick="document.getElementById('youtube_link_div').style.display='block';document.getElementById('embed_link_div').style.display='none';document.getElementById('vimeo_link_div').style.display='none';document.getElementById('files_div').style.display='none';document.getElementById('youtube_link').value=''">
                                                <i class="primary"></i>
                                                {{ __('backend.bannerVideoType2') }}
                                            </label>
                                            &nbsp; &nbsp;
                                            <label class="md-check">
                                                <input type="radio" name="video_type" value="2" class="has-value"
                                                    {{ $Topic->video_type == 2 ? 'checked' : '' }} id="video_type3"
                                                    onclick="document.getElementById('youtube_link_div').style.display='none';document.getElementById('embed_link_div').style.display='none';document.getElementById('vimeo_link_div').style.display='block';document.getElementById('files_div').style.display='none';document.getElementById('vimeo_link').value=''">
                                                <i class="primary"></i>
                                                {{ __('backend.bannerVideoType3') }}
                                            </label>
                                            &nbsp; &nbsp;
                                            <label class="md-check">
                                                <input type="radio" name="video_type" value="3" class="has-value"
                                                    {{ $Topic->video_type == 3 ? 'checked' : '' }} id="video_type4"
                                                    onclick="document.getElementById('youtube_link_div').style.display='none';document.getElementById('embed_link_div').style.display='block';document.getElementById('vimeo_link_div').style.display='none';document.getElementById('files_div').style.display='none';document.getElementById('embed_link').value=''">
                                                <i class="primary"></i>
                                                Embed
                                            </label>
                                        </div>
                                ...
                                <div class="form-group row" id="youtube_link_div"
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="youtube_link" id="youtube_link" class="form-control"
                                            value="{{ $Topic->video_file }}"
                                            placeholder="'https://www.youtube.com/watch?v=JQs4QyKnYMQ" maxlength="191"
                                ...
                                <div class="form-group row" id="vimeo_link_div"
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="vimeo_link" id="vimeo_link" class="form-control"
                                            value="{{ $Topic->video_file }}" placeholder="'https://vimeo.com/131766159"
                                            maxlength="191" autocomplete="off" dir="ltr">
                                    </div>
                                </div>
                            ...
                            @if ($WebmasterSection->type == 3)
                                {{ $Topic->video_type }}
                                <div class="form-group row">
                                    <label for="audio_type"
                                        class="col-sm-2 form-control-label">{!! __('backend.audioType') !!}</label>
                                    <div class="col-sm-10">
                                        <div class="radio m-t-sm">
                                            <label class="md-check">
                                                <input type="radio" name="video_type" value="0"
                                                    {{ $Topic->video_type == 0 ? 'checked' : '' }} class="has-value"
                                                    id="audio_type1"
                                                    onclick="document.getElementById('embed_audio_div').style.display='none';document.getElementById('audio_file_div').style.display='block';document.getElementById('embed_audio').value=''">
                                                <i class="primary"></i>
                                                {{ __('backend.localFile') }}
                                            </label>
                                            &nbsp; &nbsp;
                                            <label class="md-check">
                                                <input type="radio" name="video_type" value="3"
                                                    {{ $Topic->video_type == 3 ? 'checked' : '' }} class="has-value"
                                                    id="audio_type3"
                                                    onclick="document.getElementById('embed_audio_div').style.display='block';document.getElementById('audio_file_div').style.display='none';document.getElementById('embed_audio').value=''">
                                                <i class="primary"></i>
                                                Embed
                                            </label>
                                        </div>
                                ...
                                <div id="audio_file_div"
                                    style="display: {{ $Topic->video_type == 0 ? 'block' : 'none' }}">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            @if ($Topic->audio_file != '' && $Topic->video_type == 0)
                                                <div class="box p-a-xs">
                                                    ...
                                                    <br>
                                                    <a target="_blank"
                                                        href="{{ route('fileView', ['path' => 'topics/' . $Topic->audio_file]) }}">
                                                        {{ $Topic->audio_file }} </a>
                                                </div>
                                            @endif
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <div id="undo" class="col-sm-4 p-a-xs" style="display: none">
                                                        <a
                                                            onclick="document.getElementById('topic_photo').style.display='block';document.getElementById('photo_delete').value='0';document.getElementById('undo').style.display='none';">
                                                            <i class="material-icons">
                                                                &#xe166;</i> {!! __('backend.undoDelete') !!}</a>
                                                    </div>

                                                    <input type="hidden" name="photo_delete" value="0"
                                                        id="photo_delete">
                                                </div>
                                            </div>
                                        @endif
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" autocomplete="off" name="icon"
                                                id="iconPicker" value="{{ $Topic->icon }}">
                                            <span class="input-group-btn">
                                                <button class="btn white" type="button"
                                                    id="iconPickerButton">{!! __('backend.chooseIcon') !!}</button>
                                            </span>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-sm-10">
                                        @if ($Topic->attach_file != '')
                                            <div id="topic_attach" class="col-sm-4 box p-a-xs">
                                                <a target="_blank"
                                                    href="{{ route('fileView', ['path' => 'topics/' . $Topic->attach_file]) }}">
                                                    {{ $Topic->attach_file }} </a>
                                                <br>
                                            ...
                                            <div id="undo2" class="col-sm-4 p-a-xs" style="display: none">
                                                <a
                                                    onclick="document.getElementById('topic_attach').style.display='block';document.getElementById('attach_delete').value='0';document.getElementById('undo2').style.display='none';">
                                                    <i class="material-icons">
                                                        &#xe166;</i> {!! __('backend.undoDelete') !!}</a>
                                            </div>
                                            <input type="hidden" name="attach_delete" value="0"
                                                id="attach_delete">
                                        @endif
                                        <input type="file" name="attach_file" id="attach_file" class="form-control"
                                            accept="{{ '.' . @str_replace(',', ',.', @$allowed_file_types) }}">
                                    </div>
                                </div>
                            @endif
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="text" name="tags" id="tags"
                                            class="form-control form-tags" value="{{ @implode(',', $exist_tags) }}"
                                            autocomplete="off">
                                    </div>
                                </div>
                                @push('after-styles')
                            ...
                            @include('dashboard.topics.fields.leagues-select', ['type' => 'edit'])
                            @include('dashboard.topics.fields.season-select', ['type' => 'edit'])
                            @include('dashboard.topics.fields.teams-select', ['type' => 'edit'])
                            @include('dashboard.topics.fields.players-select', ['type' => 'edit'])
                            @include('dashboard.topics.fields.matches', ['type' => 'edit'])
                                        ...
                                        <select name="page_form_id" class="form-control c-select" id="page_form_id">
                                            ...
                                            @foreach ($GeneralWebmasterSections->where('type', 6) as $FWebmasterSection)
                                                <option value="{{ $FWebmasterSection->id }}"
                                                    {{ $FWebmasterSection->id == $Topic->form_id ? "selected='selected'" : '' }}>
                                        ...
                                        <select name="popup_id" class="form-control c-select" id="popup_id">
                                            ...
                                            @foreach (\App\Models\Popup::where('status', 1)->get() as $PPopup)
                                                <option value="{{ $PPopup->id }}"
                                                    {{ $PPopup->id == $Topic->popup_id ? "selected='selected'" : '' }}>
                            ...
                            @if ($WebmasterSection->featured_status)
                                <div class="form-group row">
                                    <label for="featured1"
                                        class="col-sm-2 form-control-label">{!! __('backend.featured') !!}</label>
                                    <div class="col-sm-10">
                                        <div class="radio m-t-sm">
                                            <label class="md-check">
                                                <input type="radio" name="featured" value="1" class="has-value"
                                                    id="featured1" {{ $Topic->featured == 1 ? 'checked' : '' }}>
                                                <i class="primary"></i>
                                                {{ __('backend.yes') }}
                                            </label>
                                            &nbsp; &nbsp;
                                            <label class="md-check">
                                                <input type="radio" name="featured" value="0" class="has-value"
                                                    {{ $Topic->featured == 0 ? 'checked' : '' }} id="featured2">
                                                <i class="danger"></i>
                                                {{ __('backend.no') }}
                                            </label>
                                        </div>
                            ...
                            @if ($WebmasterSection->type == 10)
                                <div class="form-group row">
                                    <label for="hide_header1"
                                        class="col-sm-2 form-control-label">{!! __('backend.showHeader') !!}</label>
                                    <div class="col-sm-10">
                                        <div class="radio m-t-sm">
                                            <label class="md-check">
                                                <input type="radio" name="hide_header" value="0"
                                                    class="has-value" {{ $Topic->hide_header == 0 ? 'checked' : '' }}
                                                    id="hide_header1">
                                                <i class="primary"></i>
                                                {{ __('backend.yes') }}
                                            </label>
                                            &nbsp; &nbsp;
                                            <label class="md-check">
                                                <input type="radio" name="hide_header" value="1"
                                                    class="has-value" {{ $Topic->hide_header == 1 ? 'checked' : '' }}
                                                    id="hide_header2">
                                                <i class="danger"></i>
                                                {{ __('backend.no') }}
                                            </label>
                                ...
                                <div class="form-group row">
                                    <label for="hide_footer1"
                                        class="col-sm-2 form-control-label">{!! __('backend.showFooter') !!}</label>
                                    <div class="col-sm-10">
                                        <div class="radio m-t-sm">
                                            <label class="md-check">
                                                <input type="radio" name="hide_footer" value="0"
                                                    class="has-value" {{ $Topic->hide_footer == 0 ? 'checked' : '' }}
                                                    id="hide_footer1">
                                                <i class="primary"></i>
                                                {{ __('backend.yes') }}
                                            </label>
                                            &nbsp; &nbsp;
                                            <label class="md-check">
                                                <input type="radio" name="hide_footer" value="1"
                                                    class="has-value" {{ $Topic->hide_footer == 1 ? 'checked' : '' }}
                                                    id="hide_footer2">
                                                <i class="danger"></i>
                                                {{ __('backend.no') }}
                                            </label>
                                            ...
                                            <div class="radio m-t-sm">
                                                ...
                                                <label class="md-check">
                                                    <input type="radio" name="status" value="0"
                                                        class="has-value" {{ $Topic->status == 0 ? 'checked' : '' }}
                                                        id="status2">
                                                    <i class="danger"></i>
                                                    {{ __('backend.no') }}
                                                </label>
...
@push('after-scripts')
    ...
    <script type="text/javascript">
        ...
        function load_custom_fields() {
            $("#customFields").html(
                "<div class=\"text-center p-a-2 m-b light dk\"><img class=\"m-b-sm\" src=\"{{ asset('assets/dashboard/images/loading.gif') }}\" style=\"height: 35px;\"/><div class='text-muted small'>{{ __('backend.loading') }}</div></div>"
                );
                ...
                if (dropzoneElement) {
                    ...
                    if (myDropzone) {
                        myDropzone.on("success", function(file, response) {
                            $.get("{{ route('topicsPhotosList', ['webmasterId' => $WebmasterSection->id, 'id' => $Topic->id]) }}",
                                function(data) {
        ...
        @foreach (Helper::languagesList() as $ActiveLanguage)
            @if ($ActiveLanguage->box_status)
                ...
                $("#seo_url_slug_{{ @$ActiveLanguage->code }}").on('keyup change', function() {
                    if ($(this).val() != "") {
                        $("#url_in_engines_{{ @$ActiveLanguage->code }}").text("<?php echo url(''); ?>/" + slugify(
                            $(this).val()));
                    } else {
