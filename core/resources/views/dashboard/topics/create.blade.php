    ...
    <div class="padding">
        <div class="box">
                  ...
                  <span class="fa fa-calendar"></span>
                        ...
                        @if($WebmasterSection->id == 7)
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" autocomplete="off" name="source" id="source" value="{{ __('backend.source_default') }}" required maxlength="191" class="form-control">
                                </div>
                            </div>
                        @else
            ...
            <button class="btn white" type="button" id="iconPickerButton">{!!  __('backend.chooseIcon') !!}</button>
                        ...
                        @include('dashboard.topics.fields.season-select', ['type' => 'add'])
                        @include('dashboard.topics.fields.teams-select', ['type' => 'add'])
                        @include('dashboard.topics.fields.players-select', ['type' => 'add'])
                        ...
                        <div class="form-group row m-t-md">
                            <div class="offset-sm-2 col-sm-10">
                                <button type="submit" id="page_submit_btn" class="btn btn-lg btn-primary m-t"><i class="material-icons">
